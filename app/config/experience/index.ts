...
export const experienceConfig: {
  title: string
  data: { card: ExperienceCard; experiences: Experience[] }
} = {
  title: "Experience",
  data: {
    card: {
      front: { subtext: "Click to see responsibilities" },
      back: { title: "Key Responsibilities", bullet: "•", subtext: "Click to flip back" },
    },
    experiences: [
      {
