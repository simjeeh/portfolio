    ...
    <div class="max-w-7xl mx-auto px-6 py-4">
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          class="flex items-center text-xl font-bold text-white hover:text-primary transition-colors"
        >
          <Fish class="h-6 w-6 mr-2" />
          {{ navbarConfig.leftAlignText }}
        </button>
        ...
        <div class="hidden md:flex items-center gap-2">
          <button
            ...
            :class="{
              'text-primary hover:bg-white/5': activeSection === link.id,
          ...
          >
            ...
            <span
              ...
              class="absolute bottom-1 left-1/2 -translate-x-1/2 w-9 h-0.5 rounded-full bg-primary"
            />
          </button>
        </div>
